...
# from dealmonitor.backend.src.dealmonitor.features.features import clean_price
...
#         price_user = clean_price(row.get("price_user", 0.0))
#     else:
...
#     val = clean_price(cand.get("value_clean"))
#     features = {
